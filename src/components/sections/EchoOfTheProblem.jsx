...
const AnimatedCounter = ({ endValue, duration = 2000, suffix = "" }) => {
  const {
    ...
    inView,
    motion: m,
  } = useInViewAnimate({ threshold: 0.8, triggerOnce: false });
...
const PROBLEMS = [
  {
    ...
    stat: {
      value: 70,
      suffix: "%",
      label: "de PQR por Incumplimiento de Horario",
    },
    description:
  ...
  },
  {
    ...
    stat: {
      value: 16,
      suffix: "+ m³",
      label: "de Residuos recogidos en un solo punto crítico",
    },
    description:
...
export default function EchoOfTheProblem() {
  ...
  return (
    ...
    >
      ...
      >
        La acumulación de basura amenaza la salud pública, el turismo y la
        belleza histórica de la ciudad. La solución es la comunicación en tiempo
        real.
      </m.p>
